...
<html>
  <head prefix="og: http://ogp.me/ns# fb: http://ogp.me/ns/fb# githubog: http://ogp.me/ns/fb/githubog#">
    ...
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
        <title>phonegap-plugins/iOS/EmailComposerWithAttachments/EmailComposer.h at master · phonegap/phonegap-plugins</title>
    ...
    <meta content="collector.githubapp.com" name="octolytics-host" /><meta content="collector-cdn.github.com" name="octolytics-script-host" /><meta content="github" name="octolytics-app-id" /><meta content="80BB611A:1FA4:9E9FFE0:5261702E" name="octolytics-dimension-request_id" /><meta content="5502477" name="octolytics-actor-id" /><meta content="lfsci-webteam" name="octolytics-actor-login" /><meta content="c33f24c35fee08c5c87679486c08353e2f684fb334ffd13b039a802e0e166be1" name="octolytics-actor-hash" />
...
<meta content="+baHCY8cbTcqGHmfgScjA4Wa+0mmoHeOfInltLX8k+U=" name="csrf-token" />
    ...
    <link href="https://github.global.ssl.fastly.net/assets/github2-d7d75e69f99956b749f82d7790ca779647475bd9.css" media="all" rel="stylesheet" type="text/css" />
      ...
      <meta http-equiv="x-pjax-version" content="6451ac2d42cbc087b3ef452ef7eb93be">
        ...
        <link data-pjax-transient rel='permalink' href='/phonegap/phonegap-plugins/blob/ad9eac18d7796cbb840dfbab3816e29d364a8278/iOS/EmailComposerWithAttachments/EmailComposer.h'>
...
<!-- blob contrib key: blob_contributors:v21:1de1570a09d3e47d4a5d085380c8cf05 -->
      ...
      <div class="select-menu-list select-menu-tab-bucket js-select-menu-tab-bucket" data-tab-filter="branches">
        ...
        <div data-filterable-for="context-commitish-filter-field" data-filterable-type="substring">
            ...
            <div class="select-menu-item js-navigation-item selected">
              <span class="select-menu-item-icon octicon octicon-check"></span>
              <a href="/phonegap/phonegap-plugins/blob/master/iOS/EmailComposerWithAttachments/EmailComposer.h"
                 data-name="master"
                 data-skip-pjax="true"
                 rel="nofollow"
      ...
      <div class="select-menu-list select-menu-tab-bucket js-select-menu-tab-bucket" data-tab-filter="tags">
        <div data-filterable-for="context-commitish-filter-field" data-filterable-type="substring">
            ...
            <div class="select-menu-item js-navigation-item ">
              <span class="select-menu-item-icon octicon octicon-check"></span>
              <a href="/phonegap/phonegap-plugins/tree/init/iOS/EmailComposerWithAttachments/EmailComposer.h"
                 data-name="init"
                 data-skip-pjax="true"
                 rel="nofollow"
                 class="js-navigation-open select-menu-item-text js-select-button-text css-truncate-target"
            ...
            <div class="select-menu-item js-navigation-item ">
              <span class="select-menu-item-icon octicon octicon-check"></span>
              <a href="/phonegap/phonegap-plugins/tree/PG141/iOS/EmailComposerWithAttachments/EmailComposer.h"
                 data-name="PG141"
                 data-skip-pjax="true"
                 rel="nofollow"
                 class="js-navigation-open select-menu-item-text js-select-button-text css-truncate-target"
            ...
            <div class="select-menu-item js-navigation-item ">
              <span class="select-menu-item-icon octicon octicon-check"></span>
              <a href="/phonegap/phonegap-plugins/tree/BasicCLforIOS/iOS/EmailComposerWithAttachments/EmailComposer.h"
            ...
            <div class="select-menu-item js-navigation-item ">
              <span class="select-menu-item-icon octicon octicon-check"></span>
              <a href="/phonegap/phonegap-plugins/tree/AdPlugin-20100712/iOS/EmailComposerWithAttachments/EmailComposer.h"
      ...
      <div class="actions">
        <div class="button-group">
            <a class="minibutton tooltipped leftwards"
               href="github-windows://openRepo/https://github.com/phonegap/phonegap-plugins?branch=master&amp;filepath=iOS%2FEmailComposerWithAttachments%2FEmailComposer.h" title="Open this file in GitHub for Windows">
                <span class="octicon octicon-device-desktop"></span> Open
            </a>
                <a class="minibutton tooltipped upwards"
                   title="Clicking this button will automatically fork this project so you can edit the file"
                   href="/phonegap/phonegap-plugins/edit/master/iOS/EmailComposerWithAttachments/EmailComposer.h"
                   data-method="post" rel="nofollow">Edit</a>
          <a href="/phonegap/phonegap-plugins/raw/master/iOS/EmailComposerWithAttachments/EmailComposer.h" class="button minibutton " id="raw-url">Raw</a>
            <a href="/phonegap/phonegap-plugins/blame/master/iOS/EmailComposerWithAttachments/EmailComposer.h" class="button minibutton ">Blame</a>
          <a href="/phonegap/phonegap-plugins/commits/master/iOS/EmailComposerWithAttachments/EmailComposer.h" class="button minibutton " rel="nofollow">History</a>
        </div><!-- /.button-group -->
          <a class="minibutton danger empty-icon tooltipped downwards"
             href="/phonegap/phonegap-plugins/delete/master/iOS/EmailComposerWithAttachments/EmailComposer.h"
...
<span id="L25" rel="#L25">25</span>
            ...
            <td class="blob-line-code">
                    <div class="highlight"><pre><div class='line' id='LC1'><span class="c1">//</span></div><div class='line' id='LC2'><span class="c1">//  EmailComposer.h</span></div><div class='line' id='LC3'><span class="c1">//</span></div><div class='line' id='LC4'><span class="c1">//  Version 1.1</span></div><div class='line' id='LC5'><span class="c1">//</span></div><div class='line' id='LC6'><span class="c1">//  Created by Guido Sabatini in 2012.</span></div><div class='line' id='LC7'><span class="c1">//</span></div><div class='line' id='LC8'><br/></div><div class='line' id='LC9'><span class="cp">#import &lt;Foundation/Foundation.h&gt;</span></div><div class='line' id='LC10'><span class="cp">#import &lt;MessageUI/MFMailComposeViewController.h&gt;</span></div><div class='line' id='LC11'><span class="cp">#import &lt;Cordova/CDVPlugin.h&gt;</span></div><div class='line' id='LC12'><br/></div><div class='line' id='LC13'><br/></div><div class='line' id='LC14'><span class="k">@interface</span> <span class="nc">EmailComposer</span> : <span class="nc">CDVPlugin</span> <span class="o">&lt;</span><span class="n">MFMailComposeViewControllerDelegate</span><span class="o">&gt;</span> <span class="p">{</span></div><div class='line' id='LC15'>&nbsp;&nbsp;&nbsp;&nbsp;</div><div class='line' id='LC16'>&nbsp;&nbsp;&nbsp;&nbsp;</div><div class='line' id='LC17'><span class="p">}</span></div><div class='line' id='LC18'><br/></div><div class='line' id='LC19'><span class="c1">// UNCOMMENT THIS METHOD if you want to use the plugin with versions of cordova &lt; 2.2.0</span></div><div class='line' id='LC20'><span class="c1">//- (void) showEmailComposer:(NSMutableArray*)arguments withDict:(NSMutableDictionary*)options;</span></div><div class='line' id='LC21'><br/></div><div class='line' id='LC22'><span class="c1">// COMMENT THIS METHOD if you want to use the plugin with versions of cordova &lt; 2.2.0</span></div><div class='line' id='LC23'><span class="o">-</span> <span class="p">(</span><span class="kt">void</span><span class="p">)</span> <span class="n">showEmailComposer</span><span class="o">:</span><span class="p">(</span><span class="n">CDVInvokedUrlCommand</span><span class="o">*</span><span class="p">)</span><span class="n">command</span><span class="p">;</span></div><div class='line' id='LC24'><br/></div><div class='line' id='LC25'><span class="k">@end</span></div></pre></div>
            </td>
          </tr>
        </table>
  </div>
...
<div id="jump-to-line" style="display:none">
  ...
  <div class="site-footer">
    ...
    <ul class="site-footer-links">
      <li>&copy; 2013 <span title="0.04874s from github-fe117-cp1-prd.iad.github.net">GitHub</span>, Inc.</li>
